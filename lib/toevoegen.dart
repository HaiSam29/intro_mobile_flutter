...
class _ToevoegenSchermState extends State<ToevoegenScherm> {
  ...
  // --- NIEUW 2: De functie om de galerij te openen ---
  Future<void> _kiesFoto() async {
    ...
    if (gekozenBestand != null) {
      ...
      setState(() {
        // _geselecteerdeFoto = File(gekozenBestand.path);
  ...
  // gebruik dit methode om te testen, maar zit eerst de bovenstaande methode in commentaar.
  // void _opslaan() {
  //   // Stuur een test-berichtje naar de collectie 'test'
  //   FirebaseFirestore.instance.collection('test').add({
  //     'bericht': 'Verbinding is gelukt!',
          ...
          child: Column(
            children: [
              ...
              TextFormField(
                ...
                // Dit slaat de waarde op in je variabele zodra save() wordt aangeroepen
                onSaved: (waarde) {
                  _naam =
                      waarde!; // De '!' betekent: we weten zeker dat dit niet null is
                },
              ),
              ...
              TextFormField(
                ...
                // Een iets uitgebreidere validatie: minimaal 10 karakters
                validator: (ingevuldeTekst) {
              ...
              TextFormField(
                decoration: const InputDecoration(
                  ...
                  prefixText: '€ ', // Zet een mooi euroteken voor in het vakje
                ),
                keyboardType: TextInputType.number, // Dwingt het numpad open!
                validator: (ingevuldeTekst) {
                  if (ingevuldeTekst == null || ingevuldeTekst.isEmpty) {
              ...
              // --- DE VERZEND KNOP ---
              ElevatedButton(
                onPressed: _opslaan, // Koppel de opslaan-functie aan de klik
